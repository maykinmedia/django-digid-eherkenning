...
class Migration(migrations.Migration):
    # Restored so installs that never recorded this squash (they ran the
    # individual 0001..0016 migrations on <=0.19.x, then jumped straight to a
    # post-cleanup release) auto-recognize it as applied instead of trying to
    # re-create existing tables. Fresh databases still run it normally.
    replaces = [
